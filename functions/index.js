...
async function shapir(){
  ...
  snapshot.forEach( childSnapshot => {
      ...
      global[site] = {} //initilize function
          ...
          snapshot.forEach(function(childSnapshot) {
              ...
              if (siteKey == "objects"){
                  for (const [key, value] of Object.entries(siteVal)) {
                      ...
                      global[site][type] = function(...args) { return self(type, val, "self", "none", ...args) };
              ...
              if (siteKey == "functions"){
                  for (var v=0; v< siteVal.length; ++v) {
                      ...
                      global[site][funcName] = function(...mArgs) { return siteFunction(...mArgs) };
