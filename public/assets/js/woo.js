...
var properties = [], methods = [], counter=0;
                            ...
                            o.forEach(function(ob) {
                                for(p in properties){
                                    if(properties[p].field){// it won't check type properties (e.g. comment for VideoObject)
                                        ...
                                        let typeName = properties[p].type;
                                        let idVal = ob[mID]
                                        // console.log("typeIdFun: ", mID)
                                        // console.log("ob[typeId]Fun: ", ob[mID])
...
function printTHIS(){
    ...
    myCar.model = 'Mustang';
    myCar.year = 1969;
    return new Promise((resolve, reject) => { return myCar});
}
...
function combine(...args){
    ...
    setTimeout(() => { 
        ...
        (async function(){
            ...
            // var venues = await songkick.searchVenues("Music"); //songkick.EventVenue("34514")
